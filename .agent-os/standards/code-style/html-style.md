...
- Place each HTML attribute on its own line when line character count exceeds 80
- Align attributes vertically
- When the start tag is on multiple lines, put the closing `>` on it's own line
